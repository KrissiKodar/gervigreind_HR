...
def expected_number_of_states(width, height, nb_dirts):
  ...
  #orentations = 4 # north, east, south, west
  #on_or_off = 2 # on or off
  #dust_container = 2 # empty or not empty
  #all_variations = orentations*on_or_off*dust_container
  #expected_n_states = all_variations*n_grid_cells*(2**nb_dirts)
  expected_n_states = n_grid_cells*(2**nb_dirts)
